...
// import Carousel from './custom_tools/carusel.js';
import Gallery from './custom_tools/gallery.js';
// import Carousel from '@vtchinh/gallery-editorjs';
// const Gallery = require("@vtchinh/gallery-editorjs");
/**
...
// export class CarouselTool extends Carousel {
// 	constructor(params: any) {
// 		super(params);
...
// 	}
// }
export class GalleryTool extends Gallery {
	constructor(params: any) {
		super(params);
